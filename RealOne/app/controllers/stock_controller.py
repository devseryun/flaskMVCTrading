...
from app.services.transaction_service import TranService ## 조회관련 키움객체 슬랙서비스 인자값으로 받음
...
# slackService =SlackService()                            #Slack
# tranService =TranService(slackService, kiwoom)        #OnReceiveTrData
