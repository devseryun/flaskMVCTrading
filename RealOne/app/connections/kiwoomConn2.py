...
class KiwoomClass(metaclass=Singleton):       # QMainWindow : PyQt5에서 윈도우 생성시 필요한 함수
    def __init__(self):                    # Main class의 self를 초기화 한다.

        self.instance = QAxWidget('KHOPENAPI.KHOpenAPICtrl.1')       # CLSID
...
class Kiwoom:
    ...
    def stop_screen_cancel(self, sScrNo=None):
        self.kc.instance.dynamicCall("DisconnectRealData(QString)", sScrNo) # 스크린 번호 연결 끊기


    def TrDataSlot(self, screen, rqname, trcode, record, next):
        print("TrDataSlot")
        ...
        if self.tr_dqueue is not None:
            ...
            try:
                ...
                pass
        # if rqname == "예수금상세현황요청":
        #     deposit = self.kc.instance.dynamicCall("GetCommData(QString, QString, int, QString)", trcode, rqname, 0, "예수금")
        ...
        #     output_deposit = self.kc.instance.dynamicCall("GetCommData(QString, QString, int, QString)", trcode, rqname, 0, "출금가능금액")
        ...
        #     self.tempGyeJaRecord.update({"currentTotalPrice":currentTotalPrice,
        #                                  "balanceAsset":balanceAsset,
        #                                  "totalEstimateProfit":totalEstimateProfit,
        ...
        #     # if next == "2":
        #     #     self.GyeaJa(next="2")  # 다음 페이지가 있으면 전부 검색한다.
        #     # else:
                 
        #     self.detail_account_info_event_loop.exit()    
            
        # else:
        #     print("# mode: trdata_slot -sRQName:", rqname)    
    ...
    def _set_signals_slots(self):
        self.kc.instance.OnReceiveTrData.connect(self.TrDataSlot)
        self.kc.instance.OnReceiveRealData.connect(self.OnReceiveRealData)
        self.kc.instance.OnReceiveMsg.connect(self.OnReceiveMsg)
        self.kc.instance.OnReceiveChejanData.connect(self.OnReceiveChejanData)
        self.kc.instance.OnEventConnect.connect(self.OnEventConnect)
        self.kc.instance.OnReceiveRealCondition.connect(self.OnReceiveRealCondition)
        self.kc.instance.OnReceiveTrCondition.connect(self.OnReceiveTrCondition)
        self.kc.instance.OnReceiveConditionVer.connect(self.OnReceiveConditionVer)
    ...
    def CommConnect(self):
        ...
        """
        print("로그인 실행")
        self.kc.instance.dynamicCall("CommConnect()")
    ...
    def CommRqData(self, rqname, trcode, next, screen):
        ...
        :return: None
        """
        self.kc.instance.dynamicCall("CommRqData(QString, QString, int, QString)", rqname, trcode, next, screen)
    ...
    def GetLoginInfo(self, tag):
        ...
        """
        data = self.kc.instance.dynamicCall("GetLoginInfo(QString)", tag)
    ...
    def SendOrder(self, rqname, screen, accno, order_type, code, quantity, price, hoga, order_no):
        ...
        :return:
        """
        ret = self.kc.instance.dynamicCall("SendOrder(QString, QString, QString, int, QString, int, int, QString, QString)",
    ...
    def SetInputValue(self, id, value):
        ...
        :return: None
        """
        self.kc.instance.dynamicCall("SetInputValue(QString, QString)", id, value)
    ...
    def DisconnectRealData(self, screen):
        ...
        :return: None
        """
        self.kc.instance.dynamicCall("DisconnectRealData(QString)", screen)
    ...
    def GetRepeatCnt(self, trcode, rqname):
        ...
        :return: 멀티데이터의 행의 개수
        """
        count = self.kc.instance.dynamicCall("GetRepeatCnt(QString, QString)", trcode, rqname)
        return count
    ...
    def CommKwRqData(self, arr_code, next, code_count, type, rqname, screen):
        ...
        :return:
        """
        ret = self.kc.instance.dynamicCall("CommKwRqData(QString, bool, int, int, QString, QString)", arr_code, next, code_count, type, rqname, screen);
        return ret
    ...
    def GetAPIModulePath(self):
        ...
        :return: 모듈의 경로
        """
        ret = self.kc.instance.dynamicCall("GetAPIModulePath()")
        return ret
    ...
    def GetCodeListByMarket(self, market):
        ...
        """
        data = self.kc.instance.dynamicCall("GetCodeListByMarket(QString)", market)
        tokens = data.split(';')[:-1]
        return tokens
    ...
    def GetConnectState(self):
        ...
        :return: 0:미연결, 1: 연결완료
        """
        ret = self.kc.instance.dynamicCall("GetConnectState()")
        return ret
    ...
    def GetMasterCodeName(self, code):
        ...
        data = self.kc.instance.dynamicCall("GetMasterCodeName(QString)", code)
        return data
    ...
    def GetMasterListedStockCnt(self, code):
        ...
        data = self.kc.instance.dynamicCall("GetMasterListedStockCnt(QString)", code)
        return data
    ...
    def GetMasterConstruction(self, code):
        ...
        data = self.kc.instance.dynamicCall("GetMasterConstruction(QString)", code)
        return data
    ...
    def GetMasterListedStockDate(self, code):
        ...
        data = self.kc.instance.dynamicCall("GetMasterListedStockDate(QString)", code)
    ...
    def GetMasterLastPrice(self, code):
        ...
        data = self.kc.instance.dynamicCall("GetMasterLastPrice(QString)", code)
        return int(data)
    ...
    def GetMasterStockState(self, code):
        ...
        data = self.kc.instance.dynamicCall("GetMasterStockState(QString)", code)
        return data.split("|")

    def GetDataCount(self, record):
        print("GetDataCount")
        count = self.kc.instance.dynamicCall("GetDataCount(QString)", record)
        return count

    def GetOutputValue(self, record, repeat_index, item_index):
        print("GetOutputValue")
        count = self.kc.instance.dynamicCall("GetOutputValue(QString, int, int)", record, repeat_index, item_index)
        return count
    ...
    def GetCommData(self, trcode, rqname, index, item):
        ...
        """
        print("GetCommData")
        data = self.kc.instance.dynamicCall("GetCommData(QString, QString, int, QString)", trcode, rqname, index, item)
        return data.strip()

    def GetCommRealData(self, code, fid):
        print("GetCommData")
        data = self.kc.instance.dynamicCall("GetCommRealData(QString, int)", code, fid)
        return data

    def GetChejanData(self, fid):
        print("GetCommData")
        data = self.kc.instance.dynamicCall("GetChejanData(int)", fid)
        return data

    def GetThemeGroupList(self, type=1):
        print("GetThemeGroupList")
        data = self.kc.instance.dynamicCall("GetThemeGroupList(int)", type)
        tokens = data.split(';')
        if type == 0:
    ...
    def GetThemeGroupCode(self, theme_code):
        ...
        data = self.kc.instance.dynamicCall("GetThemeGroupCode(QString)", theme_code)
        data = data.split(';')
        return [x[1:] for x in data]

    def GetFutureList(self):
        print("GetFutureList")
        data = self.kc.instance.dynamicCall("GetFutureList()")
        return data
    ...
    def SetRealReg(self, screen, code_list, fid_list, opt_type):
        ret = self.kc.instance.dynamicCall("SetRealReg(QString, QString, QString, QString)", screen, code_list, fid_list, opt_type)
        return ret

    def SetRealRemove(self, screen, del_code):
        ret = self.kc.instance.dynamicCall("SetRealRemove(QString, QString)", screen, del_code)
        return ret

    def GetConditionLoad(self, block=True):
        self.condition_loaded = False

        self.kc.instance.dynamicCall("GetConditionLoad()")
        if block:
            while not self.condition_loaded:
                pythoncom.PumpWaitingMessages()

    def GetConditionNameList(self):
        data = self.kc.instance.dynamicCall("GetConditionNameList()")
    ...
    def SendCondition(self, screen, cond_name, cond_index, search, block=True):
        ...
        self.kc.instance.dynamicCall("SendCondition(QString, QString, int, int)", screen, cond_name, cond_index, search)
    ...
    def SendConditionStop(self, screen, cond_name, index):
        self.kc.instance.dynamicCall("SendConditionStop(QString, QString, int)", screen, cond_name, index)

    def GetCommDataEx(self, trcode, rqname):
        data = self.kc.instance.dynamicCall("GetCommDataEx(QString, QString)", trcode, rqname)
        return data

    def GyeJa(self,sPrevNext="0"):
        print("GyeaJa", self.account_num)
        self.kc.instance.dynamicCall("SetInputValue(String, String)", "계좌번호", self.account_num)
        self.kc.instance.dynamicCall("SetInputValue(String, String)", "비밀번호", "0000")  # 모의투자 0000
        self.kc.instance.dynamicCall("SetInputValue(String, String)", "비밀번호입력매체구분", "00")
        self.kc.instance.dynamicCall("SetInputValue(String, String)", "조회구분", "1")
        self.kc.instance.dynamicCall("CommRqData(QString, QString, int, QString)", "계좌평가잔고내역요청", "opw00018", sPrevNext, self.screen_my_info)
        self.detail_account_info_event_loop.exec_()        


    def GetTempGyeJaRecord(self):
        return self.tempGyeJaRecord
